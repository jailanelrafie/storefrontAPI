...
ordersRoutes.route('/create').post(authenticationMiddleware_1.default, handlers.createOrder);
...
ordersRoutes.route('/show/:id').get(authenticationMiddleware_1.default, handlers.getOrderByUserID);
