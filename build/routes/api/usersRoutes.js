...
const handlers = __importStar(require("../../handlers/users"));
const authenticationMiddleware_1 = __importDefault(require("../../middleware/authenticationMiddleware"));
const usersRoutes = (0, express_1.Router)();
usersRoutes.route('/index').get(authenticationMiddleware_1.default, handlers.index);
usersRoutes.route('/create').post(handlers.create);
usersRoutes.route('/show/:id').get(authenticationMiddleware_1.default, handlers.getUserByID);
